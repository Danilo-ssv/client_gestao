...
export function InsertMarcasProdutosPage() {
  ...
  const [controller, setController] = useState<InsertMarcasProdutosModel>({
    id: '',
    nome: '',
  });
  ...
  return (
    <div className="px-1 pt-1">
      <h1 className="text-2xl font-bold">Inserir Marca de Produtos</h1>
