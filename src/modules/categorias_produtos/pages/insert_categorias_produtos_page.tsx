...
export function InsertCategoriasProdutosPage() {
  ...
  const [controller, setController] = useState<InsertCategoriasProdutosModel>({
    id: '',
    nome: '',
  });
  ...
  return (
    <div className="px-1 pt-1">
      <h1 className="text-2xl font-bold">Inserir Categoria de Produtos</h1>
